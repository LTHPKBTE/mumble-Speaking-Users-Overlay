...
| **垂直同步** | 开启/关闭垂直同步。默认关闭，因为部分显卡驱动（NVIDIA/AMD）会在等待VSync时忙等导致高CPU占用。开启后下方所有FPS设置无效 |
...
- 频道过滤：开启"仅显示当前频道用户"可限制列表仅显示与您在同一频道的用户。频道归属通过 Mumble API 回调实时追踪。
